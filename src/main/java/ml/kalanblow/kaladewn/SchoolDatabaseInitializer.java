 ...
 * 
 * import com.github.javafaker.Faker; import com.github.javafaker.Name;
 * 
 * import ml.kalanblow.kaladewn.domain.school.CreateSchoolParameters; import
 ...
 * ml.kalanblow.kaladewn.service.SchoolService;
 * 
 * @Component
 * 
 * @Profile("dev") public class DatabaseInitializer implements CommandLineRunner
 * {
 * 
 ...
 * 
 * public DatabaseInitializer(SchoolService schoolService) { super();
 ...
 * ));
 * 
 * return new CreateSchoolParameters(name.name(), phoneNumber, email, address);
 * }
 * 
