 ...
 * @Component
 * 
 * @Profile("dev") public class SchoolDatabaseInitializer implements
 * CommandLineRunner {
 * 
 ...
 * 
 * public SchoolDatabaseInitializer(SchoolService schoolService) { super();
 ...
 * ));
 * 
 * return new CreateSchoolParameters(name.name(), phoneNumber, email.asString(),
 * address); }
 * 
